<?php
	...
	if(isset($busqueda) && $busqueda!=""){
		...
		$consulta_datos="SELECT usuario.usuario_id, usuario.usuario_nombre, usuario.usuario_apellido, rol.nombre, usuario.usuario_usuario, usuario.usuario_email FROM usuario LEFT JOIN rol ON usuario.rol_id = rol.id";
	...
	$conexion=conexion();
	$SQL= "SELECT usuario.usuario_id, usuario.usuario_nombre, usuario.usuario_apellido, rol.nombre, usuario.usuario_usuario, usuario.usuario_email FROM usuario LEFT JOIN rol ON usuario.rol = rol.id";
